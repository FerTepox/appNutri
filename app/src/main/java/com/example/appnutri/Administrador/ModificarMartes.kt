...
import com.example.appnutri.databinding.ActivityModificarMartesBinding
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.firestore.FirebaseFirestore

class ModificarMartes : AppCompatActivity() {
    private lateinit var binding : ActivityModificarMartesBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityModificarMartesBinding.inflate(layoutInflater)
    ...
    private fun ActualizarInfo() {
        ...
        hashMap["martest1"] = lunest1
        hashMap["martesd1"] = lunesd1
        hashMap["martest2"] = lunest2
        hashMap["martesd2"] = lunesd2
        hashMap["martest3"] = lunest3
        hashMap["martesd3"] = lunesd3
        hashMap["martest4"] = lunest4
        hashMap["martesd4"] = lunesd4
        hashMap["martest5"] = lunest5
        hashMap["martesd5"] = lunesd5
