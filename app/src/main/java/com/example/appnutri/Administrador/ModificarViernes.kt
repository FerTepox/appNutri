...
import com.example.appnutri.databinding.ActivityModificarViernesBinding
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.firestore.FirebaseFirestore

class ModificarViernes : AppCompatActivity() {
    private lateinit var binding : ActivityModificarViernesBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityModificarViernesBinding.inflate(layoutInflater)
    ...
    private fun ActualizarInfo() {
        ...
        hashMap["viernest1"] = lunest1
        hashMap["viernesd1"] = lunesd1
        hashMap["viernest2"] = lunest2
        hashMap["viernesd2"] = lunesd2
        hashMap["viernest3"] = lunest3
        hashMap["viernesd3"] = lunesd3
        hashMap["viernest4"] = lunest4
        hashMap["viernesd4"] = lunesd4
        hashMap["viernest5"] = lunest5
        hashMap["viernesd5"] = lunesd5
